...
class DataHandler: 
    def load_data(batch_size=BATCH_SIZE):
        ...
        X_train_resampled, y_train_resampled = DataHandler.oversample_data(np.array(X_train_data), np.array(Y_train_data), fraud_percentage=0.4)
    ...
    def oversample_data(X_train_data, Y_train_data, fraud_percentage=0.4):
