...
def train_model():
    ...
    net = Net(INPUT_SIZE, HIDDEN_SIZE, OUTPUT_SIZE, NUM_HIDDEN_LAYERS, dropout_rate=0)
    ...
    epoch_metrics = trainer.train(train_loader, val_loader, NUM_EPOCHS)
    ...
    trainer.save_model('./data/models/neural_network_model', {'epoch_metrics': epoch_metrics}, params)
    
    plot_metrics({'epoch_metrics': epoch_metrics})
