...
We selected the Transaction dataset in which includes 22000 Transaction, 29 features and 1 target. The target is binary, and the features are numerical. The dataset
was heavy imbalanced, so we had to balance it. We used an oversampling technique to balance the dataset.   
